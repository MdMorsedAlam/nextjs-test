    ...
    return(
       <section className="w-[600px] mx-auto mt-2">
        <ul className="flex justify-evenly gap-3 items-center ">
            ...
            <li className="font-bold cursor-pointer text-xl bg-green-500 text-white px-3 hover:bg-green-600 py-1 rounded-md"><Link href="/sign-in">Sign in Next Auth</Link></li>
           ...
           <li className="font-bold cursor-pointer text-xl bg-green-500 text-white px-3 hover:bg-green-600 py-1 rounded-md"> <Link href="/products">Products</Link></li>
